...
### Description
This sample is one of seven artifacts I developed under a contract which commenced in September 2019. You are welcome to clone/ download this. Download the repo, extract the contents then navigate to the <b>'raw'</b> folder within the <b>'hmtl'</b> folder and open <b>'contents.html'</b> using your favorite web browser (Google Chrome, ideally; if possible) to explore the entire solution.
